...
$(function(){ //This means it will execture once the page loads
    
    function update_params(){ //Function description
        ...
        update_order_details(); //Everytime we run this function, we will
    ...
    update_params(); //Here we are invoking the function on page load
    //You can also run this function every time the filter changes
    ...
    $(".option-button").click(function(){
        ...
        var selectedChild=childSelector+=".selected";
